    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${laptopInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: laptopInstance, field: 'classification', 'errors')}">
                                    <g:select name="classification" from="${tigerloaf.detail.ClassificationEnum?.values()}" keys="${tigerloaf.detail.ClassificationEnum?.values()*.name()}" value="${laptopInstance?.classification?.name()}"  />
                                </td>
                            </tr>
